...
public class MyAppreciationBean {

    private int code;
    private String msg;
    private DataDTO data;

    public static MyAppreciationBean objectFromData(String str) {

        return new Gson().fromJson(str, MyAppreciationBean.class);
    }

    public static MyAppreciationBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), MyAppreciationBean.class);
    ...
    public static List<MyAppreciationBean> arrayMyAppreciationBeanFromData(String str) {

        Type listType = new TypeToken<ArrayList<MyAppreciationBean>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<MyAppreciationBean> arrayMyAppreciationBeanFromData(String str, String key) {
