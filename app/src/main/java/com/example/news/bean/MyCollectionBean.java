...
public class MyCollectionBean {
    ...
    public static MyCollectionBean objectFromData(String str) {

        return new Gson().fromJson(str, MyCollectionBean.class);
    }

    public static MyCollectionBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), MyCollectionBean.class);
    ...
    public static List<MyCollectionBean> arrayMyCollectionBeanFromData(String str) {

        Type listType = new TypeToken<ArrayList<MyCollectionBean>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<MyCollectionBean> arrayMyCollectionBeanFromData(String str, String key) {
