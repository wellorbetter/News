...
public class MyIssueBean {
    ...
    public static MyIssueBean objectFromData(String str) {

        return new Gson().fromJson(str, MyIssueBean.class);
    }

    public static MyIssueBean objectFromData(String str, String key) {

        try {
            JSONObject jsonObject = new JSONObject(str);

            return new Gson().fromJson(jsonObject.getString(str), MyIssueBean.class);
    ...
    public static List<MyIssueBean> arrayMyIssueBeanFromData(String str) {

        Type listType = new TypeToken<ArrayList<MyIssueBean>>() {
        }.getType();

        return new Gson().fromJson(str, listType);
    }

    public static List<MyIssueBean> arrayMyIssueBeanFromData(String str, String key) {
