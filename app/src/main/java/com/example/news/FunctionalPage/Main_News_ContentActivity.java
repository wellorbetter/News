                            ...
                            public void run() {
                                if(islikeBean!=null)
                                    if(islikeBean.getData().getIsLike()==1) {
                                        Toast.makeText(Main_News_ContentActivity.this, "点赞成功", Toast.LENGTH_SHORT).show();
                                        //+1
                                        like_detail.setText(String.valueOf(newsDetailBean.getData().getLike_num() + 1));
                                    }
                                    else {
                                        Toast.makeText(Main_News_ContentActivity.this, "取消点赞成功", Toast.LENGTH_SHORT).show();
                                        //-1
                                        like_detail.setText(String.valueOf(newsDetailBean.getData().getLike_num()));
                                    }
                            }
                            ...
                            public void run() {
                                if(starBean!=null)
                                    if(starBean.getData().getIsStar()==1) {
                                        Toast.makeText(Main_News_ContentActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
                                    //+1
                                        star_detail.setText(String.valueOf(newsDetailBean.getData().getStar_num() + 1));
                                    }
                                    else {
                                        Toast.makeText(Main_News_ContentActivity.this, "取消收藏成功", Toast.LENGTH_SHORT).show();
                                        //-1
                                        star_detail.setText(String.valueOf(newsDetailBean.getData().getStar_num()));
                                    }
                            }
